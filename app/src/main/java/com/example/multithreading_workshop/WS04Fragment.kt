...
class WS04Fragment : Fragment(R.layout.fragment_ws_04) {
    ...
    private fun createSuperScope(): CoroutineScope = CoroutineScope(
        Dispatchers.Default +
                SupervisorJob()
    )
    ...
    private fun failLaunchWithException() {
        try {
            ...
            logException("failLaunchWithException::Recovered", t)
        }
    }
    ...
    private fun workWithHandledException() {
        try {
            ...
            logException("workWithHandledException", t)
        }
    }
    ...
    private fun failAwaitWithException() {
        try {
            ...
            logException("failAwaitWithException::Recovered", t)
        }
